...
5. Add tests at the lowest useful layer first, then add integration coverage around critical flows.
6. Document any architecture change in `docs/decision-log/`.
